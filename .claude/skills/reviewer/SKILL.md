...
| Command | Purpose |
|---|---|
| `paw shortcut review-pr` | Orchestrate a multi-specialist review of a task branch — triage, fan-out domain experts, synthesize findings, return verdict |
...
| Command | Purpose |
|---|---|
| `paw guidelines code-quality-review` | Code quality and maintainability calibration for code review |
| `paw guidelines performance-review` | Performance issue detection and severity calibration for code review |
| `paw guidelines security-review` | Security vulnerability detection and severity calibration for code review |
