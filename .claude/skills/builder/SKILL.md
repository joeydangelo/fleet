...
| Command | Purpose |
|---|---|
| `paw shortcut build-task` | Build, verify, and publish a paw task in an isolated worktree |
...
| `paw guidelines testing` | Test design calibration for builder agents — what to test, where to draw the mock boundary, and how to avoid testing theatre |
