...
import { getDocsBasePath, listDocs, readDoc } from '../lib/docs.js';
...
const OLD_PAW_MARKER = '<!-- DO NOT EDIT: Generated by paw setup.';
...
function installAgentsSection(repoRoot: string, skillContent: string): void {
  ...
  if (existsSync(agentsPath)) {
    ...
    if (existing.includes(PAW_BEGIN) || existing.includes(OLD_PAW_MARKER)) {
