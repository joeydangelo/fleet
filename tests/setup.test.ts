...
describe('updatePawSection — AGENTS.md markers', () => {
  ...
  it('migrates old-format AGENTS.md (DO NOT EDIT marker, no end marker)', () => {
    const content = [
      '# My Project',
      '',
    ...
    expect(result).toContain('# My Project');
    expect(result).toContain('new paw content');
    expect(result).toContain('<!-- BEGIN PAW INTEGRATION -->');
    expect(result).toContain('<!-- END PAW INTEGRATION -->');
    expect(result).not.toContain('old skill body content');
  });

  it('migrates old-format AGENTS.md preserving other integrations after paw', () => {
    const content = [
      '# My Project',
      '',
      '<!-- DO NOT EDIT: Generated by paw setup.',
    ...
    expect(result).toContain('new paw content');
    expect(result).toContain('<!-- END PAW INTEGRATION -->');
    expect(result).not.toContain('old paw content');
    // tbd content must be preserved
    expect(result).toContain('<!-- BEGIN TBD INTEGRATION -->');
    expect(result).toContain('tbd content here');
    expect(result).toContain('<!-- END TBD INTEGRATION -->');
  });
